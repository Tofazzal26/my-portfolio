...
import team1 from "../../../public/banner/team1.jpg";
import team2 from "../../../public/banner/team2.jpg";
import team3 from "../../../public/banner/team3.jpg";
import team4 from "../../../public/banner/team4.jpg";
          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex space-x-6">
              ...
              <div className="flex flex-col">
                <h4 className="text-xl font-semibold">Afran islam </h4>
            ...
            <div className="flex space-x-6">
              ...
              />
              <div className="flex flex-col">
                <h4 className="text-xl font-semibold">Rahim Ahmed</h4>
                <p className="text-sm dark:text-gray-600">Web developer</p>
                <div className="flex mt-2 space-x-2">
                  <a
                    rel="noopener noreferrer"
            ...
            <div className="flex space-x-6">
              ...
              />
              <div className="flex flex-col">
                <h4 className="text-xl font-semibold">Ahmed Siyam</h4>
                <p className="text-sm dark:text-gray-600">Web developer</p>
                <div className="flex mt-2 space-x-2">
                  <a
                    rel="noopener noreferrer"
            ...
            <div className="flex space-x-6">
              ...
              />
              <div className="flex flex-col">
                <h4 className="text-xl font-semibold">Md Himan</h4>
                <p className="text-sm dark:text-gray-600">Web developer</p>
                <div className="flex mt-2 space-x-2">
                  <a
                    rel="noopener noreferrer"
